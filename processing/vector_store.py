...
class VectorStore:
    def __init__(self, collection_name="pdf_documents", persist_directory="../persistent_directory/vector_store"):
    ...
    def add_documents(self, documents, embeddings: np.ndarray, batch_size=5000):
        ...
        # Add in batches to avoid hitting Chroma limits
